...
<body>
    <div class="sidebar">
        <a href="addstudent" class="sidebar-icon">
            <i class="fas fa-user-plus"></i>
            Add Student
        </a>
        <a href="viewallstudents" class="sidebar-icon">
            <i class="fas fa-eye"></i>
            View Students
        </a>
        <a href="updatestudent" class="sidebar-icon">
            <i class="fas fa-user-edit"></i>
            Update Student
        </a>
        <a href="deletestudent" class="sidebar-icon">
