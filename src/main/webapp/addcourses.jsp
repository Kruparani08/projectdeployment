...
<div style="text-align: center; margin-top: 20px;">
    <c:if test="${not empty message}">
        <div class="message ${status == 'success' ? 'success' : 'failure'}">
            ${message}
        </div>
    </c:if>
</div>
    ...
    <form action="/admin/addcourse" method="post">
       ...
       <!-- <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="number" id="lectureHours" name="lectureHours" oninput="calculateCredits()" required>
        </div>
        <div class="form-group">
            <label for="tutorialHours">Tutorial Hours (T)</label>
            <input type="number" id="tutorialHours" name="tutorialHours" oninput="calculateCredits()" required>
        </div>
        <div class="form-group">
            <label for="practicalHours">Practical Hours (P)</label>
            <input type="number" id="practicalHours" name="practicalHours" oninput="calculateCredits()" required>
        </div>
        <div class="form-group">
            <label for="skillHours">Skill Hours (S)</label>
            <input type="number" id="skillHours" name="skillHours" oninput="calculateCredits()" required>
        </div>
        <div class="form-group">
