...
<body>
    ...
    <div class="sidebar">
        <a href="/student/dashboard"><i class="fas fa-tachometer-alt"></i>Dashboard</a>
        <a href="/student/profile"><i class="fas fa-user"></i> My Profile</a>
        <a href="/student/viewcourses"><i class="fas fa-book"></i> Courses</a>
        <a href="coursereferences"><i class="fas fa-book"></i> Course References</a>
    ...
    <div class="main-content">
        ...
        <div class="overlay-text">
            ...
            <p>Explore your courses, update your profile, and manage your learning journey effectively.</p>
        </div>
    </div>
</body>
</html>
