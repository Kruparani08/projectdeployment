...
<body>
    <div class="sidebar">
        <a href="addinstructor" class="sidebar-icon">
            <i class="fas fa-user-plus"></i>
            Add Instructor
        </a>
        <a href="viewallinstructors" class="sidebar-icon">
            <i class="fas fa-eye"></i>
            View Instructors
        </a>
        <a href="updateinstructor" class="sidebar-icon">
            <i class="fas fa-user-edit"></i>
            Update Instructor
        </a>
        <a href="deleteinstructor" class="sidebar-icon">
